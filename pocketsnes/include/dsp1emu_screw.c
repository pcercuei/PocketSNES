...
unsigned int *CosTable2;
unsigned int *SinTable2;
#define INCR 2048
#define Angle(x) (((x)/(65536/INCR)) & (INCR-1))
#define Cos(x) (CosTable2[x])
#define Sin(x) (SinTable2[x])
...
{
        unsigned int i;
	CosTable2 = (unsigned int *) malloc(INCR*sizeof(unsigned int));
	SinTable2 = (unsigned int *) malloc(INCR*sizeof(unsigned int));
	for (i=0; i<INCR; i++){
